...
//    @ManyToOne
//    @JoinColumn(name = "flight_id",  foreignKey = @ForeignKey(name = "flights"))
//    private Flight flight;

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "flight_id",nullable = false, foreignKey = @ForeignKey(name = "FK_seat_inventory_flight"))
    private Flight flight;
